...
CODE_MODS = os.getenv("CODE_MODS")

def get_mods_access_and_refresh_token():
    ...
    try:
        ...
        set_key(r'.env', "ACCESS_TOKEN_MODS", ACCESS_TOKEN)
        set_key(r'.env', "REFRESH_TOKEN_MODS", REFRESH_TOKEN)

    except requests.exceptions.JSONDecodeError:
        raise RuntimeError("Invalid or no response. The request has failed.")

get_mods_access_and_refresh_token()