  ...
  return (
    <>
      <main className="mt-3 ml-5 mr-5 font-sans">
        ...
        <div className="flex flex-wrap gap-4 text-xl mt-6 mb-6 justify-center text-white font-semibold">
          <span className="bg-gradient-to-r from-violet-500 to-purple-700 hover:bg-purple-500 rounded-lg p-1 hover:scale-105 duration-300">
            <Link href="/commands">View commands</Link>
          </span>
          <span className="bg-gradient-to-r from-rose-500 to-pink-700 hover:bg-pink-400 rounded-lg p-1 hover:scale-105 duration-300">
            <Link href="/about">About the bot</Link>
          </span>
          <span className="bg-gradient-to-r from-cyan-600 to-sky-600 hover:bg-blue-400 rounded-lg p-1 hover:scale-105 duration-300">
        ...
        <div className="flex max-2xl:grid max-2xl:grid-cols-2 gap-10 justify-center">
          <div className="bg-gradient-to-br from-gray-800 to-gray-500 rounded-lg p-1 text-center border border-black max-w-[14%]">
