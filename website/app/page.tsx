    ...
    <>
      <main className="mt-3 ml-5 mr-5 font-sans">
        ...
        <section className="flex flex-wrap gap-4 text-xl mt-5 justify-center text-white font-semibold">
          <span className="bg-gradient-to-r from-purple-700 to-indigo-700 hover:bg-purple-500 rounded-lg p-1 hover:scale-110 duration-300">
            <Link href="/commands">View commands</Link>
          </span>
          <span className="bg-gradient-to-r from-pink-500 to-pink-700 hover:bg-pink-400 rounded-lg p-1 hover:scale-110 duration-300">
            <Link href="/about">About the bot</Link>
          </span>
          <span className="bg-gradient-to-r from-blue-600 to-sky-800 hover:bg-blue-400 rounded-lg p-1 hover:scale-110 duration-300">
        ...
        <section className="flex max-2xl:grid max-2xl:grid-cols-2 gap-10 justify-center mt-5">
          <div className="bg-gradient-to-br from-gray-800 to-gray-500 rounded-lg p-1 text-center border border-black">
